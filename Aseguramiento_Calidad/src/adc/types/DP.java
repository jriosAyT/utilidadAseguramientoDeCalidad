...
public class DP {
	...
	public static void AC_DP() throws IOException {
...
//		Rutas de acceso a excel
		String rutaArchivoEntrada = "C:/Users/lithi/Downloads/AseguramientoDeCalidad/AC-DP2.xlsx";
		String rutaArchivoSalida = "C:/Users/lithi/Downloads/AseguramientoDeCalidad/SalidaAC-DP.xlsx";
...
//				**********ATENTO A LA CABECERA DP o VELOCIDAD *************
				String dato = "{\"fechaRegistros\":" + fechaRegistroString + ",\"DP\":{" + "\"nivelCero\":{"
						+ "\"numCilindro\":" + null + "," + "\"horaInicio\":" + horaIString + ","
						+ "\"concentracionNivelPatron\":" + preValores.get(3) + "," + "\"porcentajeIncertidumbre\":"
						+ null + "," + "\"vencimiento\":" + null + "," + "\"horaRegistroLectura\":" + horaIRLAString
						+ "," + "\"escalaAnalizador\":" + preValores.get(6) + "," + "\"valorLectura\":"
						+ preValores.get(7) + "," + "\"porcentajeNivel\":" + preValores.get(4) + "," + "\"diferencia\":"
						+ preValores.get(8) + "," + "\"error\":" + preValores.get(9) + "}," + "\"nivelSpan\":{"
						+ "\"numCilindro\":" + null + "," + "\"horaInicio\":" + horaFString + ","
						+ "\"concentracionNivelPatron\":" + preValores.get(11) + "," + "\"porcentajeIncertidumbre\":"
						+ null + "," + "\"vencimiento\":" + null + "," + "\"horaRegistroLectura\":" + horaFRLAString
						+ "," + "\"escalaAnalizador\":" + preValores.get(14) + "," + "\"valorLectura\":"
						+ preValores.get(15) + "," + "\"porcentajeNivel\":" + preValores.get(12) + ","
						+ "\"diferencia\":" + preValores.get(16) + "," + "\"error\":" + preValores.get(17) + "}}}";

				valores.add(dato);
//				String str = hor;
//
//				fechaHora = new Timestamp(10, 10, 10, 10, 10, 10, 10);
//				// System.out.println(Integer.parseInt(str.substring(14)));
//
//				cantidadDias = Math.floor(((fechaHora.getTime() / 1000) / 3600) / 24) + ((365 * 70) + (19));
//				// System.out.println("cantidad de horas " + cantidadHoras);
//
//				Double minutosTotal = Math.floor((fechaHora.getTime() / 1000) / 60) + (((365 * 70) + (19)) * (24 * 60));
//				Double cantidadMinutosDias = cantidadDias * 24 * 60;
//				Double diferenciaMinutos = minutosTotal - cantidadMinutosDias;
//
//				Double decimalMinutos = diferenciaMinutos / (24 * 60);
// 				var = cantidadDias + decimalMinutos;
